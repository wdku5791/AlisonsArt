...
1. Make commits to your feature branch. Prefix each commit like so: contrib-<COMMIT TITLE>
...
```
git remote add upstream https://github.com/TenaciousTurtles/AlisonsArt.git
```
