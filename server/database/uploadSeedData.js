...
module.exports = function insertDummyData (db) {
  ...
  const artworkPromise = db.task((t) => {
  ...
  const auctionPromise = db.task((t) => {
  ...
  return Promise.all([userPromise, artworkPromise, auctionPromise, bidPromise]);
}